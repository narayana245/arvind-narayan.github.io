...
socialMedia.then(function(data) {
    ...
    // This line groups the data by AgeGroup and calculates quartile statistics (min, q1, median, q3, max) for each group using the rollupFunction
    const quantilesByGroups = d3.rollup(data, rollupFunction, d => d.AgeGroup);

    // This iterates through each age group and its calculated quantiles, extracting the x-position and box width for drawing the boxplot elements
